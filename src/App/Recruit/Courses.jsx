  ...
  return (
    <div className="bg-mobileBackground min-h-screen lg:ml-[16%]">
      ...
      <div className="py-8 px-5">
        <h2 className="text-white font-semibold text-2xl">Explore Courses</h2>
        ...
        <div className="grid grid-cols-2  md:grid-cols-3 lg:grid-cols-4 gap-x-3 gap-y-3">
          ...
          <Link to="/app/recruit/course/view">
            <div className="space-y-3 border-inputBorderColor border p-5 rounded-lg">
              ...
              <div className="flex text-textGray text-sm items-center justify-between">
                <p>12 Lessons</p>
                <p className="text-PrimaryPurple font-bold text-[20px]">$400</p>
              </div>
            </div>
          </Link>
          <Link to="/app/recruit/course/view">
