...
const RecruitNavbar = () => {
  ...
  if (currUser === "recruit") {
    return (
      <React.Fragment>
        <section className=" bg-[#101010] text-white border-solid mt-10 fixed lg:h-full flex flex-row lg:flex-col justify-evenly items-center lg:items-start shadow-md  text-3xl h-20  bottom-0  w-full lg:w-[16%] lg:px-4">
