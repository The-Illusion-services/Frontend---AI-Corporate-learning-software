...
const CreateJobs = () => {
  // i'll levae it full screen for now, it's meant to be beside the sticky navbar, so it's to have a position of relative with left of like 30% and with a width of 70%
  return (
    <div className="bg-mobileBackground w-screen min-h-screen p-10 text-white">
      {/* Basic Information */}
